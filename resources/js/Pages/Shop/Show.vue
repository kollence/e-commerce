            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2 mb-5">
                ...
                <div class="md:col-span-6 ">
                    <img :src="product.images[0].url" :alt="product.name"
                        class="object-cover border border-gray-700 rounded-lg">
                </div>
                <div class="md:col-span-4">
                    <h1 class="text-3xl font-bold mb-4">{{ product.name }}</h1>
                    <div class="flex items-end mb-4 border-b border-gray-300 pb-2">
                    ...
                    <div class="flex justify-start items-center mb-1 pb-1">
                        <div class="flex items-center mb-1 items-center mb-1 border-b border-gray-300 pb-1">
                            <span class=" mr-2">Is Active:</span>
                            <span :class="product.is_active ? 'text-green-500' : 'text-red-600'">{{ product.is_active ?
                                '&#x2714;' : ' &#x2716;' }}</span>
                        </div>
                        <div class="flex items-center mb-1 border-b border-gray-300 pb-1 ml-5">
                    ...
                    <div>
                        ...
                        <select id="countries"
                            ...
                            <option v-for="size_options in product.lowest_priced_item.size_options"
                                :key="size_options.id" value="{{size_options.id}}">{{ size_options.name }}</option>

                        </select>
                    </div>

                    <div
                        class="flex justify-between items-center mt-5 mb-1 border font-bold text-stone-200 text-lg p-4">
                        <span>
